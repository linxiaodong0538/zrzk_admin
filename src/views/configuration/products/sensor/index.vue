...
export default {
    ...
    methods: {
        ...
        search() {
            ...
            this.loading = true;
            this.$sensor.search(params).then(({ rows, total }) => {
                this.loading = false;
                this.models = rows;
        ...
        mapping(row, column, index) {
            ...
            if (property === "dataType") {
                console.log("mapping data type", property, row, row[property], this.cache.dataTypes);
                result = row[property]? this.cache.dataTypes[row[property]].dictLabel:'';
            }
            return result;
        }
    }
