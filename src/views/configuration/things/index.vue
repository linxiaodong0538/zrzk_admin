...
export default {
    ...
    data() {
        return { 
            ...
            options: [
                { prop: "wisdomDeviceId", label: "灯杆编号" },
                { prop: "deviceNo", label: "灯杆名称" },
                { prop: "deviceType", label: "所在区域" },
                { prop: "areaName", label: "经度" },
                { prop: "areaName", label: "维度" },
                { prop: "areaName", label: "项目" },
                { prop: "areaName", label: "创建日期" }
            ],
            models: [],
            /** table $ */
            /** dialog ^ */
