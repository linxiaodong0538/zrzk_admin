<template>
  <div class="xny-region">
    <!-- src/views/devices/led/material/index.vue -->
    <div>
      <div class="region">
      ...
      <div class="xny-search">
        ...
        <div class="coverForm">
          ...
          <el-table :data="typeList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="资源名称" min-width="100" align="center" prop="controllerAddress" />
            <el-table-column label="资源类型" align="center" prop="onlineState" />
            <el-table-column label="所属项目" align="center" prop="deviceState" />
            <el-table-column label="所属机构" align="center" prop="alarmView" />
            <el-table-column label="所属区域" align="center" prop="processing" />
            <!-- fixed="right" -->
...
import { region, coverForm,wellGroup } from "@/api/system/cover/coverManagement";
