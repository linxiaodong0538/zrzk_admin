<template>
  <div class="xny-xinzeng">
    ...
    <div class="coverManagement">
      <span>所属项目:</span>
      <el-select v-model="valueProject" placeholder class="Manhole">
        <el-option
      ...
      <span class="coverList">所属灯杆:</span>
      <el-select v-model="valueGateway" placeholder class="Manhole">
        <el-option
    ...
    <div class="coverManagement">
      ...
      <span class="coverList">屏幕亮度:</span>
      <el-input placeholder size="small" class="Manhole" v-model="pollTime" />
    </div>
    <div class="coverManagement">
      <span>屏幕状态:</span>
      <el-radio class="screenState" v-model="screen" label="1">开</el-radio>
      <el-radio v-model="screen" label="2">关</el-radio>
      <span class="deviceState">设备状态:</span>
      <el-radio class="screenState" v-model="device" label="1">在线</el-radio>
      <el-radio v-model="device" label="2">离线</el-radio>
    </div>
    <div class="coverManagement">
      <span>上锁状态:</span>
      <el-radio class="screenState" v-model="locked " label="1">加锁</el-radio>
      <el-radio v-model="locked" label="2">解锁</el-radio>
    </div>
