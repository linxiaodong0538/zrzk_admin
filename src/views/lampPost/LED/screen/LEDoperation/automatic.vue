<template>
  <div class="xny-xinzeng">
    ...
    <div class="coverManagement">
      <span>自动亮度:</span> <label style="color: red; ">*</label>
       <el-input placeholder="请输入灵敏度(0~100)" size="small" class="Manhole" v-model="gatewayName" />
      <span class="coverList">最小亮度:</span><label style="color: red; ">*</label>

      <el-input placeholder="请输入最小亮度(0~100)" size="small" class="Manhole" v-model="defaultGateway" />
    </div>
