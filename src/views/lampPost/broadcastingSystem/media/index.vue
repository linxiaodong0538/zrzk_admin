      ...
      <div class="xny-search">
        ...
        <div class="xny-cover">
          <div class="xny-Manhole">
            <span class="coverList">文件夹名称:</span>
        ...
        <div class="coverForm">
          ...
          <el-table :data="typeList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="文件名称" min-width="100" align="center" prop="controllerAddress" />
            <el-table-column label="文件大小" align="center" prop="onlineState" />
