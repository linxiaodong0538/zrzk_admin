      ...
      <el-input placeholder size="small" class="Manhole" v-model="defaultGateway" /> -->
        ...
        <div class="coverForm">
          ...
          <el-table :data="typeList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="编号" min-width="100" align="center" prop="controllerAddress" />
            <el-table-column label="分区名称" align="center" prop="onlineState" />
            <el-table-column label="成员" align="center" prop="deviceState" />
            <el-table-column label="所属项目" align="center" prop="alarmView" />
