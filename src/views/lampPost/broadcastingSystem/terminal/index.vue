      ...
      <div class="xny-search">
        ...
        <div class="xny-cover">
          <div class="xny-Manhole">
            <span class="coverList">终端名称:</span>
      ...
      <el-input placeholder size="small" class="Manhole" v-model="defaultGateway" /> -->
        ...
        <div class="coverForm">
          ...
          <el-table :data="typeList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="终端编号" min-width="100" align="center" prop="controllerAddress" />
            <el-table-column label="终端名称" align="center" prop="onlineState" />
            <el-table-column label="IP地址" align="center" prop="deviceState" />
            <el-table-column label="发送传播方式" min-width="120" align="center" prop="alarmView" />
            <el-table-column label="广播接收传播方式" min-width="130" align="center" prop="alarmView" />
            <el-table-column label="广播输出音量" min-width="120" align="center" prop="processing" />
            <el-table-column label="广播输入音量" min-width="120" align="center" prop="processing" />
            <el-table-column label="终端状态" align="center" prop="processing" />
            <el-table-column label="任务状态" align="center" prop="processing" />
            <el-table-column label="所属项目" align="center" prop="processing" />
            <el-table-column label="所属机构" align="center" prop="processing" />
            <el-table-column label="所属区划" align="center" prop="processing" />
            <!-- fixed="right" -->
            <!-- <el-table-column label="操作">
              <template slot-scope="scope">
                <span class="edit" @click="handleUpdate">编辑</span>
                <span class="delete" @click="handleDelete(scope.$index,typeList)">删除</span>
              </template>
            </el-table-column> -->
          </el-table>
          <!-- @pagination="getList" -->
