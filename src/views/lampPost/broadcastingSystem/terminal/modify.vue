<template>
  <div class="xny-xinzeng">
    ...
    <div class="coverManagement">
      ...
      <span class="xnt-coverList">所属项目:</span>
    ...
    <div class="coverManagement">
      ...
      <span class="coverList">灯杆编号:</span>
    ...
    <div class="coverManagement">
      <span>终端名称：</span>
      <el-input placeholder size="small" class="Manhole" v-model="defaultGateway" />
      <span class="spread">广播发送传播方式：</span>
    ...
    <div class="coverManagement">
      <span class="spread">广播接收传播方式：</span>
      <!-- <el-input placeholder size="small" class="Manhole" v-model="variableRatio" /> -->
      <el-select class="receive" v-model="value" placeholder>
        <el-option
    ...
    <div class="coverManagement">
      ...
      <span class="xnt-coverList">分组类别:</span>
    ...
    <div class="coverManagement">
      ...
      <span class="coverList">广播输出音量：</span>-->
      <!-- <el-input placeholder size="small" class="Manhole" v-model="controlBox" /> -->
