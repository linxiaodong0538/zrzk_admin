      ...
      <div class="xny-search">
        ...
        <div class="coverForm">
          ...
          <el-table :data="typeList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="任务名称" min-width="100" align="center" prop="controllerAddress" />
            <el-table-column label="是否定时" align="center" prop="onlineState" />
            <el-table-column label="播放时长" align="center" prop="deviceState" />
            <el-table-column label="开始时间" align="center" prop="alarmView" />
            <el-table-column label="开始日期" align="center" prop="processing" />
            <el-table-column label="结束日期" align="center" prop="processing" />
            <el-table-column label="执行模式" align="center" prop="processing" />
            <el-table-column label="任务终端" align="center" prop="processing" />
            <el-table-column label="状态" align="center" prop="processing" />
