<template>
  <div class="xny-region">
      ...
      <div class="xny-search">
        ...
        <div class="xny-cover">
          <div class="xny-Manhole">
            <span class="coverList">充电桩名称:</span>
        ...
        <div class="coverForm">
          ...
          <el-table :data="typeList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="充电桩名称" min-width="100" align="center" prop="controllerAddress" />
            <el-table-column label="区域名称名称" align="center" prop="onlineState" />
            <el-table-column label="创建者" align="center" prop="deviceState" />
            <el-table-column label="创建时间" align="center" prop="alarmView" />
            <el-table-column label="备注" align="center" prop="processing" />
            <!-- fixed="right" -->
    ...
    <el-dialog :title="title" :visible.sync="open" width="800px">
      <chargingPileEdit :id="management.id" :label="management.label" @cancel="cancel"></chargingPileEdit>
    </el-dialog>
  </div>
</template>
<script>
//   wellGroup
import chargingPileEdit from "./chargingPileEdit";
import { region, coverForm } from "@/api/system/cover/coverManagement";
import { treeselect } from "@/api/system/dept";
export default {
  components: { chargingPileEdit },
  data() {
    return {
      // 区域/分组
      fla: 0,
