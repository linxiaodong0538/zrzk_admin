<template>
  <div class="xny-region">
    ...
    <div class="xny-search">
      ...
      <div class="xny-cover">
        <!-- 图表搜索 -->
        <div class="xny-Manhole" v-show="statistics==0">
        ...
        <!-- 列表搜素 -->
        <div class="xny-Manhole" v-show="statistics==1">
      ...
      <div class="coverForm1">
        <div class="xny-LuminaireData">
          <span
            class="LuminaireData"
            :class="{xny_LightingRate:statistics==0}"
            @click="statistics=0"
          >图表</span>
          <span
            class="LightingRate"
            :class="{xny_LightingRate:statistics==1}"
            @click="statistics=1"
          >列表</span>
        </div>
        <!-- autoresize -->
        <div class="leakageEcharts" id="leakage"  v-show="statistics==0"></div>
        <div v-if="statistics==1">
          ...
          <el-table :data="typeList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="电表名称" align="center" prop="lanternsName" />
            <el-table-column label="采集时间" align="center" prop="lanternsName" />
            <el-table-column
              label="漏损电量(预测)"
              min-width="120"
              align="center"
...
export default {
  ...
  methods: {
    ...
    cherts() {
      var leakage = this.$echarts.init(document.getElementById("leakage"));
      leakage.setOption({
        title: {
          text: "漏电数据  福州/年份 "
        },
