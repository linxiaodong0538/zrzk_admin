      ...
      <div class="xny-search">
        ...
        <div class="xny-cover">
          <div class="xny-Manhole">
            <span class="coverList">电表类型:</span>
            <el-select v-model="value" placeholder>
             ...
             <span class="coverList">电表名称:</span>
        ...
        <div class="coverForm">
          ...
          <el-table :data="typeList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="设备类型" min-width="100" align="center" prop="controllerAddress" />
            <el-table-column label="电表地址" align="center" prop="onlineState" />
            <el-table-column label="电表名称" align="center" prop="deviceState" />
            <el-table-column label="在线状态" align="center" prop="alarmView" />
            <el-table-column label="修改日期" align="center" prop="processing" />
            <el-table-column label="修改人" align="center" prop="voltage" />
            <el-table-column label="添加日期" align="center" prop="current" />
            <el-table-column label="添加人" min-width="100" align="center" prop="activePower" />
          </el-table>
            <!-- fixed="right" -->
          <!-- @pagination="getList" -->
          <pagination
...
export default {
  ...
  data() {
    return {
      ...
      typeList: [
        {
          controllerAddress: "2", //灯控制器地址
          onlineState: "-", //在线状态
          deviceState: "鼓东总表", //设备状态
          alarmView: "离线", //报警查看
          processing: "-", //一键处理
          voltage: "-", //电压
          current: "-", //电流
