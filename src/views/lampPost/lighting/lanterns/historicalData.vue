<template>
  <div>
      ...
      <div class="coverForm">
        <div class="xny-LuminaireData">
          <span
            ...
            @click="Lighting=0"
          >灯具收据</span>
          <span class="LightingRate" :class="{xny_LightingRate:Lighting==1}" @click="Lighting=1">亮灯率</span>
        </div>
        <div v-if="Lighting==0">
          ...
          <el-table :data="typeList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="灯具名称" align="center" prop="lanternsName" />
            <el-table-column label="灯具类型" align="center" prop="lanternsName" />
            <el-table-column
              label="灯控制器地址"
              min-width="100"
              align="center"
            ...
            <el-table-column label="灯具数据">
              <template slot-scope="scope">
                <span class="viewData" @click="viewData">查看数据</span>
              </template>
            </el-table-column>
            <el-table-column label="电能数据">
              <template slot-scope="scope">
                <span class="viewData" @click="electricEnergy">查看电能</span>
              </template>
            </el-table-column>
          </el-table>
          <!-- @pagination="getList" -->
        ...
        <div v-if="Lighting==1">
          ...
          <el-table :data="typeList" @selection-change="handleSelectionChange">
            <el-table-column type="selection" width="55" align="center" />
            <el-table-column label="亮灯率" align="center" prop="lanternsName" />
            <el-table-column label="亮灯数" align="center" prop="lanternsName" />
            <el-table-column label="总数" min-width="100" align="center" prop="controllerAddress" />
            <el-table-column label="记录时间" align="center" prop="reportingTime" />
            <el-table-column label="所属项目" align="center" prop="reportingTime" />
          </el-table>
          <!-- @pagination="getList" -->
          <pagination
            v-show="total>0"
    ...
    <el-dialog :title="title" :visible.sync="open" width="800px">
      <viewDataAdd :id="management.id" :label="management.label" @cancel1="cancel1"></viewDataAdd>
    </el-dialog>
    <el-dialog :title="title" :visible.sync="openelectricEnergy" width="800px">
      <electricEnergyAdd :id="management.id" :label="management.label" @cancel="cancel"></electricEnergyAdd>
    </el-dialog>
  </div>
</template>
<script>
import viewDataAdd from "./viewDataAdd";
import electricEnergyAdd from "./electricEnergyAdd";
import {
  region,
  coverForm,
  wellGroup
...
export default {
  ...
  methods: {
    ...
    /**查看电能 */
    electricEnergy() {
      this.openelectricEnergy = true;
    },
    cancel(val) {
      this.openelectricEnergy = val;
      this.reset();
    }
  }
};
