    ...
    <div class="xny-search">
      ...
      <div class="coverForm">
        ...
        <el-table :data="typeList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="产品名称" align="center" prop="lanternsName" />
          <el-table-column label="设备编号" min-width="100">
            <template slot-scope="scope">
              <span class="viewData" @click="deviceInformation">{{scope.row.equipmentNumber }}</span>
            </template>
          </el-table-column>
          <el-table-column label="部件编号" align="center" prop="onlineState" />
          <el-table-column label="区域" align="center" prop="deviceState" />
