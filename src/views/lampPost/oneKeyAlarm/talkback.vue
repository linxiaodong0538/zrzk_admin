      ...
      <el-input placeholder size="small" class="Manhole" v-model="defaultGateway" />
        ...
        <div class="coverForm">
          ...
          <el-table :data="typeList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="设备名称" min-width="100" align="center" prop="controllerAddress" />
            <el-table-column label="所属灯杆" align="center" prop="onlineState" />
            <el-table-column label="所属区域" align="center" prop="deviceState" />
            <el-table-column label="所属机构" align="center" prop="alarmView" />
            <el-table-column label="智慧路灯" align="center" prop="processing" />
            <el-table-column label="111001" align="center" prop="processing" />
            <!-- fixed="right" -->
