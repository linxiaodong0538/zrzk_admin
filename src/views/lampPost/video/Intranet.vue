        ...
        <div class="ui-layout-content">
          <div class="vcontrol">
            ...
            <div class="vsetting">
              <el-row :gutter="3">
                <el-col :span="16">
                  <el-input v-model="predot" size="mini" placeholder="请输入预置点"></el-input>
                </el-col>
                <el-col :span="8">
                  <el-button type="primary" plain @click="add" size="mini">添加</el-button>
                </el-col>
              </el-row>
              <el-row :gutter="3">
                <el-col :span="10">
                ...
                <el-col :span="7">
                  <el-button type="info" plain @click="remove" size="mini">删除</el-button>
                </el-col>
              </el-row>
            </div>
          </div>
