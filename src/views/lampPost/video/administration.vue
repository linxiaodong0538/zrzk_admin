<template>
  <div class="xny-region">
      ...
      <div class="xny-search">
        ...
        <div class="xny-cover">
          <div class="xny-Manhole">
            <span class="coverList">设备名称:</span>
        ...
        <div class="coverForm">
          ...
          <el-table :data="typeList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="别名" min-width="100" align="center" prop="controllerAddress" />
            <el-table-column label="IP地址" align="center" prop="onlineState" />
            <el-table-column label="端口" align="center" prop="deviceState" />
            <el-table-column label="用户名" align="center" prop="alarmView" />
            <el-table-column label="网络类型" align="center" prop="processing" />
            <el-table-column label="是否在线" align="center" prop="processing" />
            <el-table-column label="是否为NVR" align="center" prop="processing" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="800px">
      <administrationAdded :id="management.id" :label="management.label" @cancel="cancel"></administrationAdded>
    </el-dialog>
  </div>
</template>
<script>
//   wellGroup
import administrationAdded from "./administrationAdded";
import { region, coverForm } from "@/api/system/cover/coverManagement";
import { treeselect } from "@/api/system/dept";
export default {
  components: { administrationAdded },
  data() {
    return {
      // 区域/分组
      fla: 0,
