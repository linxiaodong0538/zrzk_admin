    ...
    <div class="xny-search">
      ...
      <div class="coverForm">
        ...
        <el-table :data="typeList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="操作动作" align="center" prop="lanternsName" />
          <el-table-column label="操作描述" align="center" prop="controllerAddress" />
          <el-table-column label="用户" align="center" prop="onlineState" />
          <el-table-column label="操作时间" align="center" prop="deviceState" />
        </el-table>
        <!-- @pagination="getList" -->
        <pagination
          v-show="total>0"
...
export default {
  ...
  data() {
    return {
      ...
      typeList: [
        {
          lanternsName: "修改设备信息", //灯具名称
          controllerAddress: "部件信息修改", //灯控制器地址
          onlineState: "老张", //在线状态
          deviceState: "2019.09.11  11:13:40", //设备状态
