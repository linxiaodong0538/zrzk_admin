    ...
    <div class="xny-search">
      ...
      <div class="coverForm">
        ...
        <el-table :data="typeList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="采集时间" min-width="140" align="center" prop="lanternsName" />
          <el-table-column label="上报时间" min-width="140" align="center" prop="controllerAddress" />
          <el-table-column label="剩余电量" align="center" prop="onlineState" />
          <el-table-column label="电池电压" align="center" prop="deviceState" />
          <el-table-column label="信号强度" align="center" prop="" />
          <el-table-column label="信噪比" align="center" prop="" />
          <el-table-column label="倾斜监测" align="center" prop="" />
          <el-table-column label="满溢状态" align="center" prop="" />
          <el-table-column label="位移状态" align="center" prop="" />
          <el-table-column label="开盖监测" align="center" prop="" />
