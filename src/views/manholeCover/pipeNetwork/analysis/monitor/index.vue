    ...
    <div class="xny-search">
      ...
      <div class="coverForm">
        ...
        <el-table :data="typeList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="COD" align="center" prop="reactivePower" />
          <el-table-column label="ORP" align="center" prop="powerFactor" />
          <el-table-column label="总磷" align="center" prop="temperature" />
          <el-table-column label="总氮" align="center" prop="temperature" />
          <el-table-column label="余氯" align="center" prop="temperature" />
          <el-table-column label="温度" align="center" prop="temperature" />
          <el-table-column label="PH" align="center" prop="temperature" />
          <el-table-column label="电导率" align="center" prop="temperature" />
          <el-table-column label="浊度" align="center" prop="temperature" />
          <el-table-column label="溶解氧" align="center" prop="temperature" />
          <el-table-column label="上传时间" align="center" prop="temperature" />
        </el-table>
        <!-- @pagination="getList" -->
        <pagination
          v-show="total>0"
