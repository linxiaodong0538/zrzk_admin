    ...
    <div class="xny-search">
      ...
      <div class="coverForm">
        ...
        <el-table :data="typeList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="设备类型" align="center" prop="controllerAddress" />
          <el-table-column label="控制器地址" align="center" prop="onlineState" />
          <el-table-column label="上报时间" align="center" prop="deviceState" />
            <el-table-column label="详细数据">
              <template slot-scope="scope">
                <!-- @click="handleUpdate" -->
                <el-button class="edit" icon="el-icon-edit" type="primary">查看数据</el-button>
              </template>
            </el-table-column>
        </el-table>
        <!-- @pagination="getList" -->
...
export default {
  ...
  data() {
    return {
      ...
      typeList: [
        {
          lanternsName: "井盖", //灯具名称
          controllerAddress: "积水探测井盖", //灯控制器地址
          onlineState: "-", //在线状态
          deviceState: "2019-12-19 15:06:47", //设备状态
          alarmView: "-", //报警查看
          processing: "-", //一键处理
          voltage: "-", //电压
          current: "-", //电流
