    ...
    <div class="xny-search">
      ...
      <div class="coverForm">
        ...
        <el-table :data="typeList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="设备编号" align="center" prop="lanternsName" />
          <el-table-column label="区域名称" align="center" prop="controllerAddress" />
          <el-table-column label="产品名称" align="center" prop="onlineState" />
          <el-table-column label="产品类型" align="center" prop="deviceState" />
...
<script>
//   wellGroup
import { region,wellGroup, coverForm } from "@/api/system/cover/coverManagement";
